...
public class Utility {
     ...
     * @return The 2D X coordinate.
     */
    public static int xs(final float i, float j) {
        if (j < Medium.cz) {
            j = Medium.cz;
        }
        return (int) ((j - Medium.focus_point) * (Medium.cx - i) / j + i);
    }
     ...
     * @return The 2D Y coordinate.
     */
    public static int ys(final float i, float j, int m) {
        int value = 0;
        switch (m) {
            case 0:
                value = Medium.cz;
        ...
        return (int) ((j - Medium.focus_point) * (Medium.cy - i) / j + i);
    }
    ...
    public static BufferedImage webGet(String string) throws IOException {
        ...
        return new BufferedImage(string);
    }
    ...
    public static float spy(float i, float j) {
        return (float) Math.sqrt((i - Medium.cx) * (i - Medium.cx) + j * j);
    }
