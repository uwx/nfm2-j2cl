...
public abstract class AbstractAction implements Action, Cloneable, Serializable {
	 ...
	 */
	private transient Map<String, Object> arrayTable;
	...
	public Object[] getKeys() {
		...
		keys = arrayTable.keySet().toArray(keys);
		return keys;
	}
	...
	protected Object clone() throws CloneNotSupportedException {
		AbstractAction newAction = (AbstractAction) ShallowClone.clone(this);
		synchronized (this) {
			if (arrayTable != null) {
				newAction.arrayTable = new Hashtable<>(arrayTable);
			}
		}
		return newAction;
	}
