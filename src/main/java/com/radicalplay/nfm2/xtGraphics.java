...
//        }
    ...
    public Image credsnap(Image image) {
        ...
        return app.createImage(500, 500);
...
//            runner = null;
    ...
    private void loadimages() {
        ...
        kaff = loadWebImage("kaff.jpg");
        carsbg = loadWebImage("cars.gif");
//            smokey = loadWebImage("smokey.gif");
        orank[0] = loadWebImage("1.gif");
        ogameh = loadWebImage("gameh.gif");
        gameov = loadWebImage("gameov.gif");
        olap = loadWebImage("lap.gif");
        paused = loadWebImage("paused.gif");
        select = loadWebImage("select.gif");
        oyourwasted = loadWebImage("yourwasted.gif");
        oyouwastedem = loadWebImage("youwastedem.gif");
        dude[0] = loadWebImage("d1.gif");
        dude[1] = loadWebImage("d2.gif");
        dude[2] = loadWebImage("d3.gif");
        oflaot = loadWebImage("float.gif");
        ocntdn[1] = loadWebImage("1c.gif");
        ocntdn[2] = loadWebImage("2c.gif");
        ocntdn[3] = loadWebImage("3c.gif");
        orank[1] = loadWebImage("2.gif");
        orank[2] = loadWebImage("3.gif");
        orank[3] = loadWebImage("4.gif");
        orank[4] = loadWebImage("5.gif");
        orank[5] = loadWebImage("6.gif");
        orank[6] = loadWebImage("7.gif");
        bgmain = loadWebImage("bgmain.jpg");
        br = loadWebImage("br.gif");
        oloadingmusic = loadWebImage("loadingmusic.gif");
        radicalplay = loadWebImage("radicalplay.gif");
        back[0] = loadWebImage("back.gif");
        back[1] = bressed(back[0]);
        contin[0] = loadWebImage("continue2.gif");
        contin[1] = bressed(contin[0]);
        next[0] = loadWebImage("next.gif");
        next[1] = bressed(next[0]);
        pgate = loadWebImage("pgate.gif");
        rpro = loadWebImage("rpro.gif");
        selectcar = loadWebImage("selectcar.gif");
        trackbg[0][0] = loadWebImage("track1.jpg");
        trackbg[1][0] = dodgen(trackbg[0][0]);
        trackbg[0][1] = loadWebImage("track2.jpg");
        trackbg[1][1] = dodgen(trackbg[0][1]);
        oyoulost = loadWebImage("youlost.gif");
        oyouwon = loadWebImage("youwon.gif");
        ocntdn[0] = loadWebImage("0c.gif");
        odmg = loadWebImage("damage.gif");
        opwr = loadWebImage("power.gif");
        opos = loadWebImage("position.gif");
        owas = loadWebImage("wasted.gif");
        ostar[0] = loadWebImage("start1.gif");
        ostar[1] = loadWebImage("start2.gif");
        star[2] = pressed(ostar[1]);
        congrd = loadWebImage("congrad.gif");
        statb = loadWebImage("statb.gif");
        statbo = loadWebImage("statbo.gif");
        mdness = loadWebImage("madness.gif");
        fixhoop = loadWebImage("fixhoop.gif");
        sarrow = loadWebImage("arrow.gif");
        stunts = loadWebImage("stunts.gif");
        racing = loadWebImage("racing.gif");
        wasting = loadWebImage("wasting.gif");
        plus = loadWebImage("plus.gif");
        space = loadWebImage("space.gif");
        arrows = loadWebImage("arrows.gif");
        chil = loadWebImage("chil.gif");
        ory = loadWebImage("ory.gif");
        kz = loadWebImage("kz.gif");
        kx = loadWebImage("kx.gif");
        kv = loadWebImage("kv.gif");
        kp = loadWebImage("kp.gif");
        km = loadWebImage("km.gif");
        kn = loadWebImage("kn.gif");
        kenter = loadWebImage("kenter.gif");
        nfm = loadWebImage("nfm.gif");
        opti = loadWebImage("options.gif");
        opback = loadWebImage("opback.gif");
        logocars = loadWebImage("logocars.gif");
        logomadnes = loadWebImage("logomadmess.gif");
        logomadbg = loadWebImage("logomadbg.gif");
        byrd = loadWebImage("byrd.gif");
        nfmcoms = loadWebImage("nfmcoms.gif");
        nfmcom = loadWebImage("nfmcom.gif");
        dnload += 3;
        HLogger.info("Images loaded: " + howManyImages);
        System.gc();
    }

    private Image loadWebImage(String s) {
        return new ImageImpl("data/images/" + s);
    }
...
//        return createImage(new MemoryImageSource(j, i, ai, 0, j));
    ...
    private void loading() {
        ...
        rd.drawImage(sign, 297, 10, null);
        rd.drawImage(hello, 60, 80, null);
        ...
        rd.drawImage(loadbar, 216, 340, null);
        rd.setFont(new Font("SansSerif", 1, 11));
        FontHandler.fMetrics = rd.getFontMetrics();
    ...
    public xtGraphics(Graphics2D graphics2d, GameSparker applet) {
        ...
        app = applet;
        rd = graphics2d;
        hello = Toolkit.getDefaultToolkit().getImage("data/hello.gif");
        sign = Toolkit.getDefaultToolkit().getImage("data/sign.gif");
        loadbar = Toolkit.getDefaultToolkit().getImage("data/loadbar.gif");
        int i = 0;
        do {
            loadedt[i] = false;
        } while (++i < 17);
    ...
    public void blendude(Image image) {
        ...
        do {
            ...
            if (dudo != -1) {
                ...
                dudeb[j] = image; // createImage(new MemoryImageSource(122, 160, ai1, 0, 122));
            }
        } while (++j < 3);
    }
...
//        runner.start();
    ...
    public void loadsounds() {
        ...
        for (i = 0; i < 5; ++i) {
            for (int v = 0; v < 5; ++v) {
                sm.add("engs" + v + i, new SoundClipWeb(v + "" + i + ".wav"));
            }
        }

        for (i = 0; i < 6; ++i) {
            sm.add("air" + i, new SoundClipWeb("air" + i + ".wav"));
        }

        for (i = 0; i < 3; ++i) {
            sm.add("crash" + i, new SoundClipWeb("crash" + (i + 1) + ".wav"));
        }

        for (i = 0; i < 3; ++i) {
            sm.add("lowcrash" + i, new SoundClipWeb("lowcrash" + (i + 1) + ".wav"));
        }

        for (i = 0; i < 3; ++i) {
            sm.add("skid" + i, new SoundClipWeb("skid" + (i + 1) + ".wav"));
        }

        for (i = 0; i < 3; ++i) {
            sm.add("dustskid" + i, new SoundClipWeb("dustskid" + (i + 1) + ".wav"));
        }

        sm.add("powerup", new SoundClipWeb("powerup.wav"));
        sm.add("tires", new SoundClipWeb("tires.wav"));
        sm.add("checkpoint", new SoundClipWeb("checkpoint.wav"));
        sm.add("carfixed", new SoundClipWeb("carfixed.wav"));
        sm.add("three", new SoundClipWeb("three.wav"));
        sm.add("two", new SoundClipWeb("two.wav"));
        sm.add("one", new SoundClipWeb("one.wav"));
        sm.add("go", new SoundClipWeb("go.wav"));
        sm.add("wasted", new SoundClipWeb("wasted.wav"));
        sm.add("firewasted", new SoundClipWeb("firewasted.wav"));
