...
import java_impl.TextMetricsEx;
...
//    }
    ...
    public int stringWidth(String str) {
        TextMetricsEx textMetrics = getTextMetricsEx(str, null);
        return (int) textMetrics.width;
    }
...
//    }
    ...
    public Rectangle2D getStringBounds( String str, Graphics context) {
        TextMetricsEx textMetrics = getTextMetricsEx(str, context);
    ...
    private WebGraphics2D sharedGraphics;
    private TextMetricsEx getTextMetricsEx(String str, Graphics context) {
        if (context == null) {
        ...
        TextMetricsEx textMetrics = Js.uncheckedCast(((WebGraphics2D) context).context.measureText(str));
    ...
    public Rectangle2D getStringBounds( String str,
                                        int beginIndex, int limit,
                                        Graphics context) {
        return getStringBounds(str.substring(beginIndex, limit - beginIndex), context);
    }
    ...
    public Rectangle2D getStringBounds( char [] chars,
                                        int beginIndex, int limit,
                                        Graphics context) {
        return getStringBounds(new String(chars, beginIndex, limit), context);
    }
