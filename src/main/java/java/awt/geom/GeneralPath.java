 ...
 * behavior of its superclass {@link Float}. Together with
 * {@link Double}, the {@link Path2D} classes provide full
...
public final class GeneralPath extends Path2D.Float {
	/**
	 * Constructs a new empty single precision {@code GeneralPath} object with a
